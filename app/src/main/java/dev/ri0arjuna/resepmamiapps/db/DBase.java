...
public class DBase extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_FAVORITE_MAKANAN = "favorite_makanan";
    Context context;
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(" CREATE TABLE " + TABLE_NAME + " (" +
                ...
                COLUMN_FAVORITE_MAKANAN + " INTEGER NOT NULL);"
        );
    ...
    public List<ModelFood> makananList() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                modelMakanan.setFavoritedFood(cursor.getInt(cursor.getColumnIndex(COLUMN_FAVORITE_MAKANAN)));
